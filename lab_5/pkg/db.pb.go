...
type ResultadoGetAll struct {
	...
	Datos map[string][]byte `protobuf:"bytes,1,rep,name=datos,proto3" json:"datos,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ResultadoGetAll) GetDatos() map[string][]byte {
	if x != nil {
		return x.Datos
	}
	return nil
...
var file_pkg_db_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
